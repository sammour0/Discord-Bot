...
const duas = [
    ...
    "اللهم ارزقني زوجة صالحة، جميلة الخَلق والخُلق، طيبة المعشر، صحيحة البدن، تقر بها عيني وتسعد بها نفسي",
    "اللهم ارزقني زوجة صالحة، حسنة المظهر والجسد، تعينني على طاعتك وتكون سكنًا لي",
    "اللهم يا جامع الناس ليوم لا ريب فيه اجمعني بزوجة صالحة، جميلة، عفيفة، تعينني في ديني ودنياي",
    "اللهم يا مقلب القلوب ثبت قلبي على دينك، وارزقني من فضلك العظيم زوجةً صالحةً تسعدني وتسعد بها حياتي",
    "اللهم زوّج Neiagros و ahmad و Sammour و Himd و Omar alhamad والشباب كلها بالزوجات الصالحات"
];
